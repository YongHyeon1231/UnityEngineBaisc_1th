...
namespace DynamicArray
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            IEnumerator<double> enumerator = da_double.GetEnumerator(); //이렇게쓰는 이유는 자료구조가 여러가지이기 때문이다.

            //MyDynamicArray<double>.MyDynamicArrayEnum<double> enumerator_2 = da_double.GetEnumerator();
            ...
            // using : Dispose () 호출을 보장하는 구문. IDisaposable 을 상속받은 객체만 인자로 줄 수 있다.
