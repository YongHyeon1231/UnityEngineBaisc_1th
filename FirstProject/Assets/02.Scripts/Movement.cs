...
public class Movement : MonoBehaviour
{
    ...
    // SerializedFeild : 내 필드/프로퍼티를 외부에 공개하고싶지 않으면서 인스펙터창에서는 노출시키고싶을때 사용하는 Attribute
    ...
    /// 둘중에 하나라도 RigidBody를 가지고 있고, 둘중에 하나라도 Trigger 를 가지고 있어야 한다.
    /// </summary>
    ...
    /// <summary>
    /// Coollider - RigidBody 간의 상호작용. 접촉시 호출
    /// </summary>
